...
export default function TaskModal({
                                    ...
                                    initialData,
                                    selectedWorkspace,
                                    workspaces = []  // ✅ ШИНЭ: Бүх workspace-ийн жагсаалт
                                  }) {
  ...
  // ✅ Тухайн task-ын workspace-ийг олох
  const currentWorkspace = workspaces.find(ws =>
      ws._id === (initialData?.workspaceId || selectedWorkspace)
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const submitData = {
        ...formData,
        workspaceId: initialData?.workspaceId || selectedWorkspace,
          ...
          <div className="bg-gradient-to-r from-primary-600 to-primary-800 p-6 relative flex-shrink-0">
            ...
            <div className="relative z-10 flex items-center justify-between">
              <div>
                ...
                {currentWorkspace && (
                    <div className="mt-3 inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm border border-white/25 rounded-lg px-3 py-1.5">
